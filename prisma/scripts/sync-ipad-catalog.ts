...
const pencils = [
  ...
  },
  {
    ...
    highlights: ["Совместим с iPad Pro M5, iPad Air M4 и iPad A16", "Пиксельная точность и низкая задержка", "Наведение на совместимых моделях iPad", "Магнитное крепление и зарядка по USB‑C"],
    specs: {
      ...
      "Совместимость": "iPad Pro 11″ и 13″ M5, iPad Air 11″ и 13″ M4, iPad A16 и другие совместимые iPad с USB‑C",
  ...
  },
  {
    ...
    highlights: ["Полная совместимость с iPad Pro M5 и iPad Air M4", "Сжатие, вращение пера и тактильный отклик", "Наведение и двойное касание", "Магнитное крепление, зарядка и поддержка «Локатора»"],
    specs: {
      "Подключение": "Bluetooth",
